...
class User
{
	...
	public function updateImageBanniere()
	{
		$requete = $GLOBALS['database']->prepare("UPDATE `utilisateur` SET img_banniere=:imageBanniere WHERE `id_utilisateur`= :id");
		$requete->bindValue(':imageBanniere', $this->img_banniere);
		$requete->bindValue(':id', $this->id);
